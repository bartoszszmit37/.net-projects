...
{
    public partial class QuadraticFunctionAndHejDemonstration : Form
    {
        ...
        private void QuadraticFunctionAndHejDemonstration_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            this.Hide();
            this.Parent = null;
        ...
        private void ButtonOneBtn_Click(object sender, EventArgs e)
        {
            ...
            if (Checked._checkedTextBoxQFA == true)
            {
                ...
                _qFunSS++;
               // _a += Convert.ToDouble(TextBoxQFATxb.Text);
            ...
            if (Checked._checkedTextBoxQFB == true)
            {
                ...
                _qFunSSB++;
                //  _b += Convert.ToDouble(TextBoxQFBTxb.Text);
