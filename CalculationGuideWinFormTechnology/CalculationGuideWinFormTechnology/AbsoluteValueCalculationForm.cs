...
namespace PrzewodnikKalkulacyjny
{
    ...
    {
        //public String CommaSymbol = ",";
        //public String MinusSymbol = "-";

        // public String _valueString;

        //  public bool _isComma;
        //  public bool _isMinus;
        ...
        /*private void IsCommaCheckerMethod()
        {
            var _valueToAbsSS = ValueToAbsTxb.SelectionStart;
            _valueString = ValueToAbsTxb.Text;
            _isComma = _valueString.Contains(CommaSymbol);
            if (_isComma == true || ValueToAbsTxb.Text == "" || ValueToAbsTxb.Text == null || ValueToAbsTxb.Text == "-")
            {
                ButtonCommaBtn.Enabled = false;
            }
            else if (_isComma == false && ValueToAbsTxb.Text != null && _valueToAbsSS == 0)
            {
                ButtonCommaBtn.Enabled = false;
            }
            else if (_isComma == false && ValueToAbsTxb.Text != null && _valueToAbsSS > 0)
            {
                ButtonCommaBtn.Enabled = true;
            }
        }*/
        /*private void IsMinusCheckerMethod()
        {
            var _valueToAbsSS = ValueToAbsTxb.SelectionStart;
            _valueString = ValueToAbsTxb.Text;
            ...
            if (_isMinus == true)
            {
                ButtonMinusBtn.Enabled = false;
            }
            else if (_isMinus == false || ValueToAbsTxb.Text != null)
            {
                ButtonMinusBtn.Enabled = true;
            }
            else if (_valueToAbsSS > 0 || ValueToAbsTxb.Text != null)
            {
                ButtonMinusBtn.Enabled = false;
            }
            else if (_isMinus == false && _valueToAbsSS == 0 && ValueToAbsTxb.Text != null)
            {
                ButtonMinusBtn.Enabled = true;
            }
        ...
        private void ButtonOneBtn_Click(object sender, EventArgs e)
        {
            ...
            if (Checked._checkedValueToAbs == true)
            {
                ...
                //_charChecker.IsCommaCheckerMethod();
               // _charChecker.IsMinusCheckerMethod();

            }
        }

        private void ValueToAbsTxb_MouseEnter(object sender, EventArgs e)
        {
        ...
        private void ButtonResoultBtn_Click(object sender, EventArgs e)
        {
            ...
            //bool plus = str.Contains("+");
            // bool minus = str.Contains("-")
            int _resultAbs = 0;
        ...
        private void AbsoluteValueCalculationForm_Load(object sender, EventArgs e)
        {
