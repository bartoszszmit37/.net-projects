...
namespace PrzewodnikKalkulacyjny
{
    ...
    public class CharChecker
    {
        ...
        public void IsCommaCheckerMethod()
        {
           ...
           // _isCommaInAbs = _valueString.Contains(CommaSymbol);
          //   if (_isCommaInAbs == true || _absValueCF.ValueToAbsTxb.Text == "" || _absValueCF.ValueToAbsTxb.Text == null || _absValueCF.ValueToAbsTxb.Text == "-")
           //  {
          //       _absValueCF.ButtonCommaBtn.Enabled = false;
          //   }
          //   else if (_isCommaInAbs == false && _absValueCF.ValueToAbsTxb.Text != null && _valueToAbsSS == 0)
          //   {
          //       _absValueCF.ButtonCommaBtn.Enabled = false;
          //   }
          //   else if (_isCommaInAbs == false && _absValueCF.ValueToAbsTxb.Text != null && _valueToAbsSS > 0)
          //   {
         //        _absValueCF.ButtonCommaBtn.Enabled = true;
         //    }
        ...
        public void IsMinusCheckerExpFunAMethod()
        {
            ...
            else if ( _expFun.TextBoxEFA.Text != null && _valueExpFunASS > 0)
            {
                _expFun.ButtonMinusEFBtn.Enabled = false;
            }*/
