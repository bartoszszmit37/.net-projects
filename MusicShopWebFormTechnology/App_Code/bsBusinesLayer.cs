...
public class bsBusinesLayer
{
    ...
    public bsKlasaUsera bs_BalWyswietlMojLogin(string bs_login_par, string bs_haslo_par)
    {
        ...
        //bs_DataAccessLayer bs_warstwa_dostepu = new bs_DataAccessLayer();
        //string bs_zapytanie = "select bs_Id_user, bs_Login from bs_Uzytkownicy where bs_Login=@bs_Login";
    ...
    public bsAdministrator bs_BalWyswietlLoginAdmina(string bs_login_par, string bs_haslo_par)
    {
        ...
        foreach (DataRow bs_dr in bs_dt.Rows)
        {
            ...
            //bs_admin.bsHasloAdmin = bs_dr["bsHasloAdmin"].ToString();
            //bs_obiekt_uzytkownika.bsLoginUsera = bs_dr["bsLoginAdmin"].ToString();
